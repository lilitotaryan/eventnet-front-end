...
import { signActions, eventsActions, sortingActions } from 'redux/actions';
...
export default function AdminNavbarLinks() {
  ...
  const isCompany = useSelector(state => state.userData.is_company);
  ...
  function handleSearch() {
    ...
    dispatch(sortingActions.searchEvents(search));
    dispatchEvents();
  }

  const handleChange = event => {
    console.log('search handle value', event.target.value);
  ...
  return (
    <div>
      {history.location.pathname === '/events' || history.location.pathname === '/myevents' ? (
