                ...
                <GridItem xs={12} sm={12} md={6}>
                  ...
                  >
                    <InputLabel
                      ...
                      error={!old_password.isValidPassword && !reset}
                    >
                      Old Password
                    </InputLabel>
                    <OutlinedInput
                      ...
                      endAdornment={
                        <InputAdornment position="end">
                          <IconButton
                            ...
                            onClick={() => setOldVisibility(!showOldPassword)}
                            edge="end"
                          >
                      ...
                      labelWidth={110}
                    />
                    <FormHelperText error={!old_password.isValidPassword && !reset}>
                      {!old_password.isValidPassword && !reset ? 'Invalid Input' : null}
                    </FormHelperText>
                  </FormControl>
                </GridItem>
                <GridItem xs={12} sm={12} md={6}>
