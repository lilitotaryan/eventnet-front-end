      ...
      <Grid container item sm={6} xs={11} justify="space-between">
        <Grid item sm={5} xs={12}>
          ...
          <Typography paragraph>
            The donations made on this site are sent through a secured connection and processed by
            Stripe. This site is compliant with the Payment Card Industry and Data Security
            Standard. Read more about Stripe security{' '}
            <Link href="https://stripe.com/docs/security/stripe" target="_blank" alt="Stripe">
              here
            </Link>
            .
          </Typography>
        ...
        <Grid item sm={5} xs={11}>
          ...
          <Typography paragraph>
            ...
            and{' '}
            <Link href="https://stripe.com/docs/stripe-js/react" target="_blank">
              React Stripe
            </Link>
